...
CREATE INDEX IF NOT EXISTS idx_ad_views_viewed_at ON public.ad_views(viewed_at DESC);
CREATE INDEX IF NOT EXISTS idx_ad_views_device_type ON public.ad_views(device_type);
CREATE INDEX IF NOT EXISTS idx_ad_views_user_id ON public.ad_views(user_id);

CREATE INDEX IF NOT EXISTS idx_link_clicks_ad_id ON public.link_clicks(ad_id);
CREATE INDEX IF NOT EXISTS idx_link_clicks_clicked_at ON public.link_clicks(clicked_at DESC);
CREATE INDEX IF NOT EXISTS idx_link_clicks_device_type ON public.link_clicks(device_type);
